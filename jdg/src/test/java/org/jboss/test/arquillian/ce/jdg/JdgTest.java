...
@Template(url = "https://raw.githubusercontent.com/jboss-openshift/application-templates/master/datagrid/datagrid65-https.json",
        ...
        parameters = {
                @TemplateParameter(name = "HOSTNAME_HTTP", value = "jdg-http-route.mluksa.openshift"),
                @TemplateParameter(name = "HOSTNAME_HTTPS", value = "jdg-https-route.mluksa.openshift"),
...
@OpenShiftResources({
        ...
        @OpenShiftResource("https://raw.githubusercontent.com/jboss-openshift/application-templates/master/secrets/datagrid-app-secret.json")
})
public class JdgTest {
    private static final boolean USE_SASL = true;

    public static final String HTTP_ROUTE_HOST = "jdg-http-route.mluksa.openshift";
    public static final String HTTPS_ROUTE_HOST = "jdg-https-route.mluksa.openshift";
